/*
  # Create interview-recordings storage bucket
  
  1. New Storage Bucket
     - `interview-recordings` bucket for storing mock interview audio recordings
     
  2. Security
     - Enable appropriate security policies for user recordings
